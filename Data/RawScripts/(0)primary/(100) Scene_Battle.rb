...
class Scene_Battle < Scene_Base
  ...
  #--------------------------------------------------------------------------
  def show_fast?
    return (Input.press?(PadConfig.dash) or Input.press?(PadConfig.decision))
  end
  #--------------------------------------------------------------------------
  # * Frame Update
  #--------------------------------------------------------------------------
  ...
  def create_info_viewport
    @info_viewport = Viewport.new(0, 288, $screen_width, 128)
    @info_viewport.z = 100
    ...
    @status_window.x = 128
    @actor_command_window.x = $screen_width
    @info_viewport.visible = false
  end
  #--------------------------------------------------------------------------
  ...
  def start_skill_selection
    ...
    @skill_window = Window_Skill.new(0, 56, $screen_width, 232, @active_battler)
  ...
  def start_item_selection
    @help_window = Window_Help.new
    @item_window = Window_Item.new(0, 56, $screen_width, 232)
  ...
  def display_animation(targets, animation_id)
    if animation_id < 0
      ...
      display_attack_damage_animation(targets, animation_id)
    end
    wait(20)
    wait_for_animation
  end
  ...
  def display_attack_animation(targets)
    if @active_battler.is_a?(Game_Enemy)
      ...
      display_attack_damage_animation(targets, aid1, false)
      display_attack_damage_animation(targets, aid2, true)
    end
    wait_for_animation
  end
  #--------------------------------------------------------------------------
  ...
  #--------------------------------------------------------------------------
  def display_attack_damage_animation(targets, animation_id, mirror = false)
