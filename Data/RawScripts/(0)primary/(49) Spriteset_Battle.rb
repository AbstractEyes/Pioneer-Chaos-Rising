...
#~     create_enemies
  ...
  def create_viewports
    @viewport1 = Viewport.new(0, 0, $screen_width, $screen_width)
    @viewport2 = Viewport.new(0, 0, $screen_width, $screen_width)
    @viewport3 = Viewport.new(0, 0, $screen_width, $screen_width)
    @viewport2.z = 50
    @viewport3.z = 100
  end
  #--------------------------------------------------------------------------
