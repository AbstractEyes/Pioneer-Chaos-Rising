...
class Game_Battler
  ...
  attr_accessor :red_flash
  attr_accessor :green_flash
  ...
  #    Used, for example, when someone tries to put to sleep a (0)character
  ...
  #    (0)character that is already incapacitated. It does not apply in cases
  ...
  def add_state(state_id)
    ...
    unless state?(state_id)               # Is this state not added?
      ...
      unless inputable?                   # If the (0)character cannot act
